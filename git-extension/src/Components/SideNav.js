    ...
    >
      ...
      <div className="h-[80%] w-full p-2 flex items-start justify-start flex-col overflow-hidden overflow-y-auto text-sm scroll my-2">
        ...
        <span
          ...
          value={"How to push files to git?"}
          onClick={handleQuery}
        >
          <span className="flex gap-2 items-center justify-center text-base">
            <FiMessageSquare />
            <span className="text-sm">How to push files to git?</span>
          </span>
        </span>
        <span
          ...
          value={"Give command to commit"}
          onClick={handleQuery}
        >
          <span className="flex gap-2 items-center justify-center text-base">
            <FiMessageSquare />
            <span className="text-sm">Give command to commit</span>
          </span>
        </span>
      </div>
      {/* bottom section  */}
